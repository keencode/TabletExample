...
#import "KCPropertyListViewController.h"
#import "KCProperty+Network.h"
#import "KCPropertyTableViewCell.h"

@interface KCPropertyListViewController ()

@end

@implementation KCPropertyListViewController
...
{
    static NSString *CellIdentifier = @"PropertyTableViewCell";
    KCPropertyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    ...
    cell.descriptionLabel.text = property.hotelContent;
    ...
    NSString *addressStr;
    for (NSString *addStr in property.address) {
        addressStr = [addressStr stringByAppendingString:addStr];
